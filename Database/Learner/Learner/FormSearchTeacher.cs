...
namespace Learner
{
    public partial class FormSearchTeacher : Form
    {
        ...
        private void FormSearchTeacher_Load(object sender, EventArgs e)
        {
            ...
            displayCategory.Text = " Welcome to the Teacher Search Window ";
        ...
        private void toSearchStudentRecord()
        {
            ...
            if (searchCategory == "course")
                ...
                toSearchLabel.Text = "Enter teacher name: ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (searchCategory == "course")
                sql = "SELECT * FROM teacher WHERE tcourse = @toSearchText";
            else if (searchCategory == "name")
                sql = "SELECT * FROM teacher WHERE tname = @toSearchText";
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        result.Text += $"{dr["tid"]}  {dr["tname"]} {dr["tage"]} {dr["tgender"]} {dr["temail"]} {dr["tphoneno"]} {dr["tpwd"]}  {dr["tcourse"]}  {dr["texperience"]} {dr["tqualification"]}  {dr["tjoin_date"]}\n";
                    }
                }
                else
                {
